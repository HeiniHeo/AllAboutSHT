    ...
    return(
        <>
            <div className="office_worker">
                <div>
                    <h3>근로소득자 소득조회</h3>
                    <p><a href="https://www.nhis.or.kr/nhis/index.do"><img src="/국민건강보험.png" /></a>국민건강보험사이트에서 보수월액 조회</p>
                </div>
            </div>
            <div className="entrepreneur">
                <div>
                    <h3>사업소득자 소득조회</h3>
                    <p><a href="https://hometax.go.kr/websquare/websquare.html?w2xPath=/ui/pp/index.xml"><img src="hometax.png"/></a>국세청 홈택스 사이트에서 종합소득세 조회</p>
